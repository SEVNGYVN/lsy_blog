    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#faf9fd', fontFamily: 'Inter, sans-serif', marginTop: '-80px' }}>
        ...
        <main style={{ paddingTop: '7rem', paddingBottom: '5rem' }}>
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem', marginBottom: '3rem' }}>
            <a href={articles[0].externalUrl} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <div style={{
              ...
              >
                <div style={{ aspectRatio: '16/10', overflow: 'hidden', background: '#1a1a2e' }}>
                  <img src={articles[0].image} alt={articles[0].title} style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                </div>
          ...
          {/* Article Grid (나머지 기사들) — 외부 링크로 이동 */}
          <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
              {articles.map((article, i) => (
                <a key={i} href={article.externalUrl} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                  <div style={{
                  ...
                  >
                    <div style={{ aspectRatio: '16/10', overflow: 'hidden', background: '#f0f0f4' }}>
                      <img
                        src={article.image}
                        alt={article.title}
