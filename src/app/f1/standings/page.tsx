...
const driverStandings = [
  { pos: 1, firstName: 'Kimi', lastName: 'Antonelli', team: 'Mercedes', points: 72, color: '#00A19C', image: '/M_ANT.png', flag: '🇮🇹' },
  { pos: 2, firstName: 'George', lastName: 'Russell', team: 'Mercedes', points: 63, color: '#00A19C', image: '/M_RUS.png', flag: '🇬🇧' },
  ...
  { pos: 7, firstName: 'Max', lastName: 'Verstappen', team: 'Red Bull Racing', points: 18, color: '#152E52', image: '/R_VER.png', flag: '🇳🇱' },
  { pos: 8, firstName: 'Fernando', lastName: 'Alonso', team: 'Aston Martin', points: 16, color: '#358C75', image: '/AM_ALO.png', flag: '🇪🇸' },
  { pos: 9, firstName: 'Lance', lastName: 'Stroll', team: 'Aston Martin', points: 14, color: '#358C75', image: '/AM_STR.png', flag: '🇨🇦' },
  { pos: 10, firstName: 'Pierre', lastName: 'Gasly', team: 'Alpine', points: 12, color: '#005073', image: '/A_GAS.png', flag: '🇫🇷' },
  { pos: 11, firstName: 'Isack', lastName: 'Hadjar', team: 'Red Bull Racing', points: 10, color: '#152E52', image: '/R_HAD.png', flag: '🇫🇷' },
  { pos: 12, firstName: 'Esteban', lastName: 'Ocon', team: 'Haas F1 Team', points: 10, color: '#5E6D75', image: '/H_OCO.png', flag: '🇫🇷' },
  { pos: 13, firstName: 'Oliver', lastName: 'Bearman', team: 'Haas F1 Team', points: 8, color: '#5E6D75', image: '/H_BEA.png', flag: '🇬🇧' },
  { pos: 14, firstName: 'Carlos', lastName: 'Sainz', team: 'Williams', points: 6, color: '#061D3D', image: '/W_SAI.png', flag: '🇪🇸' },
  { pos: 15, firstName: 'Franco', lastName: 'Colapinto', team: 'Alpine', points: 4, color: '#005073', image: '/A_COL.png', flag: '🇦🇷' },
  { pos: 16, firstName: 'Alexander', lastName: 'Albon', team: 'Williams', points: 3, color: '#061D3D', image: '/W_ALB.png', flag: '🇹🇭' },
  { pos: 17, firstName: 'Liam', lastName: 'Lawson', team: 'Racing Bulls', points: 2, color: '#003BD1', image: '/RB_LAW.png', flag: '🇳🇿' },
  { pos: 18, firstName: 'Nico', lastName: 'Hülkenberg', team: 'Audi', points: 1, color: '#7D1600', image: '/AD_HUL.png', flag: '🇩🇪' },
  { pos: 19, firstName: 'Gabriel', lastName: 'Bortoleto', team: 'Audi', points: 0, color: '#7D1600', image: '/AD_BOR.png', flag: '🇧🇷' },
  { pos: 20, firstName: 'Arvid', lastName: 'Lindblad', team: 'Racing Bulls', points: 0, color: '#003BD1', image: '/RB_LIN.png', flag: '🇬🇧' },
  { pos: 21, firstName: 'Sergio', lastName: 'Pérez', team: 'Cadillac', points: 0, color: '#4B4C53', image: '/C_PER.png', flag: '🇲🇽' },
  { pos: 22, firstName: 'Valtteri', lastName: 'Bottas', team: 'Cadillac', points: 0, color: '#4B4C53', image: '/C_BOT.png', flag: '🇫🇮' },
];
...
/* ───────────────────────────────────────────
   ...
   ─────────────────────────────────────────── */
const teamStandings = [
  { pos: 1, name: 'Mercedes', points: 135, color: '#00A19C', image: '/M_CAR.png', drivers: 'Antonelli · Russell' },
  ...
  { pos: 5, name: 'Red Bull Racing', points: 28, color: '#152E52', image: '/R_CAR.png', drivers: 'Verstappen · Hadjar' },
  { pos: 6, name: 'Haas F1 Team', points: 18, color: '#5E6D75', image: '/H_CAR.png', drivers: 'Ocon · Bearman' },
  { pos: 7, name: 'Alpine', points: 16, color: '#005073', image: '/A_CAR.png', drivers: 'Gasly · Colapinto' },
  { pos: 8, name: 'Williams', points: 9, color: '#061D3D', image: '/W_CAR.png', drivers: 'Sainz · Albon' },
  { pos: 9, name: 'Racing Bulls', points: 2, color: '#003BD1', image: '/RB_CAR.png', drivers: 'Lawson · Lindblad' },
  { pos: 10, name: 'Audi', points: 1, color: '#7D1600', image: '/AD_CAR.png', drivers: 'Hülkenberg · Bortoleto' },
  { pos: 11, name: 'Cadillac', points: 0, color: '#4B4C53', image: '/C_CAR.png', drivers: 'Pérez · Bottas' },
];
