...
const driverStandings = [
  { pos: 1, firstName: 'Kimi', lastName: 'Antonelli', team: 'Mercedes', points: 156, color: '#38d2b8', image: '/M_ANT_NB.png', flag: 'it' },
  { pos: 2, firstName: 'Lewis', lastName: 'Hamilton', team: 'Ferrari', points: 115, color: '#DC0000', image: '/F_HAM_NB.png', flag: 'gb' },
  { pos: 3, firstName: 'George', lastName: 'Russell', team: 'Mercedes', points: 106, color: '#38d2b8', image: '/M_RUS_NB.png', flag: 'gb' },
  { pos: 4, firstName: 'Charles', lastName: 'Leclerc', team: 'Ferrari', points: 75, color: '#DC0000', image: '/F_LEC_NB.png', flag: 'mc' },
  { pos: 5, firstName: 'Lando', lastName: 'Norris', team: 'McLaren', points: 73, color: '#FF8000', image: '/ML_NOR_NB.png', flag: 'gb' },
  { pos: 6, firstName: 'Oscar', lastName: 'Piastri', team: 'McLaren', points: 68, color: '#FF8000', image: '/ML_PIA_NB.png', flag: 'au' },
  { pos: 7, firstName: 'Max', lastName: 'Verstappen', team: 'Red Bull Racing', points: 55, color: '#3671C6', image: '/R_VER_NB.png', flag: 'nl' },
  { pos: 8, firstName: 'Pierre', lastName: 'Gasly', team: 'Alpine', points: 41, color: '#0090FF', image: '/A_GAS_NB.png', flag: 'fr' },
  { pos: 9, firstName: 'Isack', lastName: 'Hadjar', team: 'Red Bull Racing', points: 34, color: '#3671C6', image: '/R_HAD_NB.png', flag: 'fr' },
  { pos: 10, firstName: 'Liam', lastName: 'Lawson', team: 'Racing Bulls', points: 28, color: '#003BD1', image: '/RB_LAW_NB.png', flag: 'nz' },
  { pos: 11, firstName: 'Oliver', lastName: 'Bearman', team: 'Haas F1 Team', points: 18, color: '#B6BABD', image: '/H_BEA_NB.png', flag: 'gb' },
  { pos: 12, firstName: 'Franco', lastName: 'Colapinto', team: 'Alpine', points: 16, color: '#0090FF', image: '/A_COL_NB.png', flag: 'ar' },
  { pos: 13, firstName: 'Arvid', lastName: 'Lindblad', team: 'Racing Bulls', points: 13, color: '#003BD1', image: '/RB_LIN_NB.png', flag: 'gb' },
  { pos: 14, firstName: 'Carlos', lastName: 'Sainz', team: 'Williams', points: 6, color: '#041E3C', image: '/W_SAI_NB.png', flag: 'es' },
  { pos: 15, firstName: 'Alexander', lastName: 'Albon', team: 'Williams', points: 5, color: '#041E3C', image: '/W_ALB_NB.png', flag: 'th' },
  { pos: 16, firstName: 'Esteban', lastName: 'Ocon', team: 'Haas F1 Team', points: 3, color: '#B6BABD', image: '/H_OCO_NB.png', flag: 'fr' },
  { pos: 17, firstName: 'Gabriel', lastName: 'Bortoleto', team: 'Audi', points: 2, color: '#7D1600', image: '/AD_BOR_NB.png', flag: 'br' },
  { pos: 18, firstName: 'Fernando', lastName: 'Alonso', team: 'Aston Martin', points: 1, color: '#358C75', image: '/AM_ALO_NB.png', flag: 'es' },
  { pos: 19, firstName: 'Nico', lastName: 'Hülkenberg', team: 'Audi', points: 0, color: '#7D1600', image: '/AD_HUL_NB.png', flag: 'de' },
  { pos: 20, firstName: 'Valtteri', lastName: 'Bottas', team: 'Cadillac', points: 0, color: '#4B4C53', image: '/C_BOT_NB.png', flag: 'fi' },
  { pos: 21, firstName: 'Sergio', lastName: 'Pérez', team: 'Cadillac', points: 0, color: '#4B4C53', image: '/C_PER_NB.png', flag: 'mx' },
