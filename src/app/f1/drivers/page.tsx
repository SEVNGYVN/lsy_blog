...
const drivers = [
  { slug: 'drivers/LEC', firstName: 'Charles', lastName: 'Leclerc', team: 'Ferrari', number: 16, color: '#DC0000', image: '/F_LEC.png' },
  ...
  return (
    ...
    letterSpacing: '-0.03em', margin: '0 0 2rem 0', fontFamily: "'Inter', sans-serif",}}>
      ...
      <div style={{
        ...
        {drivers.map((driver) => (
          <Link key={driver.slug} href={`/f1/drivers/${driver.slug}`} style={{ textDecoration: 'none' }}>
            <div
              style={{
                borderRadius: '16px',
                overflow: 'hidden',
